...
class BasinCamelsPL(Basin):
    ...
    def __init__(
        ...
        super(BasinCamelsPL, self).__init__(
            model=model,
            path_data=path_data,
            basin_id=basin_id,
    ...
    def _read_data(self) -> Dict[str, pd.DataFrame]:
        ...
        # load time series
        df = read_data_camelspl(path_data=self.path_data, basin_id=self.basin_id)
    ...
    def check_basins(path_data: str,
        ...
        for basin in basins_id:
            ...
            df = read_data_camelspl(path_data=path_data, basin_id=basin)
...
def read_data_camelspl(path_data: str, basin_id: str) -> pd.DataFrame:
    """Read data for a specific basin from the CAMELS PL dataset
    ...
    """
    path_timeseries = path_data + "/timeseries/CAMELS_PL_hydromet_timeseries_" + basin_id + ".csv"
