...
class BasinCamelsDE(Basin):
    ...
    code the _read_data method, that specify how we should read the information from CAMELS DE.
    ...
    def __init__(
        ...
        super(BasinCamelsDE, self).__init__(
            model=model,
            path_data=path_data,
            basin_id=basin_id,
    ...
    def _read_data(self) -> Dict[str, pd.DataFrame]:
        ...
        # load time series
        df = read_data_camelsde(path_data=self.path_data, basin_id=self.basin_id)
    ...
    def check_basins(path_data: str,
        ...
        for basin in basins_id:
            ...
            df = read_data_camelsde(path_data=path_data, basin_id=basin)
...
def read_data_camelsde(path_data: str, basin_id: str) -> pd.DataFrame:
    """Read data for a specific basin from the CAMELS DE dataset
    ...
    """
    path_timeseries = path_data + "/timeseries/CAMELS_DE_hydromet_timeseries_" + basin_id + ".csv"
