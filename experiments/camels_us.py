...
if __name__ == "__main__":
    ...
    path_entities = "../../Hy2DL/data/basin_id/basins_camels_us_5.txt"
    path_data = "../../Hy2DL/data/CAMELS_US"
    forcing = "daymet"
    path_additional_features = "../../Hy2DL/data/CAMELS_US/pet_hargreaves.pickle"
    ...
    #training_period = "../../Hy2DL/data/CAMELS_US/train_split_file_new.p"
    #testing_period = "../../Hy2DL/data/CAMELS_US/test_split_file_new.p"
    batch_size = 20
    warmup_period = 365
    random_seed = 42

    model = "HBV" # Bucket, HBV, Nonsense, SHM
    dataset = "CAMELS_US" # CAMELS_GB, CAMELS_US, CAMELS_DE
