...
if __name__ == "__main__":
    ...
    path_entities = "../../Hy2DL/data/basin_id/basins_camels_de_5.txt"
    path_data = "../../Hy2DL/data/CAMELS_DE"
    path_additional_features = "../../Hy2DL/data/CAMELS_DE/pet_hargreaves.pickle"
    ...
    dataset = "CAMELS_DE" # CAMELS_GB, CAMELS_US, CAMELS_DE
